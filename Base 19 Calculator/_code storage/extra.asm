...
.print_begin:
                ...
                mov     r13,    rax             ;   store value in r13
                mov     r11,    10              ;   x
...
.while_2_true:
                                ;   divide x times
                                mov     rax,        r14             ; gotten from _stack_pop
                                mov     rdx,        0
                                mov     rcx,        19              ; rcx = divisor
                                div     rcx
...
;   r11 =   r12_'s conversion f(x) index
...
.set_var:
    ...
    call    printf
                ...
                lea     rbx,    [VARS]
                mov     [rbx + rcx],    rax     ; rax_stack_val -> VARS[rax_index]

                mov     r13,    rax
                call    _stack_push

                jmp     _input_main.input_epilogue ;input_loop
...
section .data
    ...
    str_error_syntax      db      "'=' Syntax Error... (-_-)",CR,LF, 0
